...
#!/usr/bin/env python3
"""
Inference harness for LPneuroBLS v7 (DNS — Defect-Noise Scenario).
...
def print_summary(checkpoint, total, gt_f, gt_i,
    ...
    w = 66
    print("\n" + "=" * w)
    print(f"Result Summary: LPneuroBLS v7")
...
def main():
    ...
    parser.add_argument('--out_dir',      type=str,   default='./inference_out_v7')
