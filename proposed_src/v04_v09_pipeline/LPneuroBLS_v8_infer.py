...
#!/usr/bin/env python3
"""
Inference harness for LPneuroBLS v8 (adds AHL lattice-reduction stage) (DNS — Defect-Noise Scenario).
...
def print_summary(checkpoint, total, gt_f, gt_i,
    ...
    w = 66
    print("\n" + "=" * w)
    print(f"Result Summary: LPneuroBLS v8")
...
def main():
    ...
    parser.add_argument('--out_dir',      type=str,   default='./inference_out_v8')
